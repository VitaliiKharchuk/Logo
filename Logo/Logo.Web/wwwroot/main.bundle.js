    ...
    HomeComponent.prototype.uploadFile = function () {
        ...
        for (var _i = 0; _i < fi.files.length; _i++) {
            ...
            this.homeService.uploadFile(formData)
                ...
                if (!data.success && data.message) {
                    console.log(data.message);
                    _this.pushErrorNotification('Загрузка файла прошло неуспешно' + data.message);
                }
                else {
                    console.log('upload file success');
                    _this.pushSuccessNotification('Загрузка файла прошло успешно');
                }
                _this.closeUploadFileModal.nativeElement.click();
                _this.loadRootFiles();
            }, function (error) {
                ...
                console.log('Cant upload file', error);
                _this.closeUploadFileModal.nativeElement.click();
                _this.pushErrorNotification('Загрузка файла прошло неуспешно');
            });
        }
    };
    //folders
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_20_angular2_notifications__["NotificationsService"]
